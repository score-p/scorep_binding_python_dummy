...
setup(
    name='scorep-dummy',
    version='4.4',
    description='This is a dummy package for the scorep package',
...
The goal is to allow the presence of user instrumentation in packages even if no Score-P is present.
''',
